...
public class JudgeController {
    ...
    public String getHistoryByUserId(
        ...
        data.put("historyList",judgeService.getHistoryByUserId(Integer.parseInt(userId),Integer.parseInt(year)));
        String result= JSON.toJSONStringWithDateFormat(new Result(data,"200","获取历史审核信息成功"),"yyyy-MM-dd");
