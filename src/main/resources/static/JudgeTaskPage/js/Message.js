...
$(function () {
    layui.use('laypage', function () {
        ...
        function loadPage(page1,limit1){
            $.ajax({
                url: '/system/getAllSystemByAcceptUID',
                type: "GET",
                data: {
                    acceptUID: userId,
                    page:page1,
                ...
                success: function (resultData) {
                    ...
                    if(resultData.data.total>0){
                        ...
                        for(var i=0;i<resultData.data.sysList.length;i++){
                            var str="<li class='layui-timeline-item'><i class='layui-icon layui-timeline-axis'></i><div class='layui-timeline-content layui-text'><h3 class='layui-timeline-title'>"+resultData.data.sysList[i].create_time+"</h3><p>"+resultData.data.sysList[i].message+"</p></div></li>";
