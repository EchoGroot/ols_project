    ...
    layui.use(['layer', 'form','table'], function() {
        ...
        var tableIns=table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'release_time', title: '发布时间', align: 'center', width: '12%', sort: true}
                , {field: 'finish_time', title: '完成时间', align: 'center', width: '12%', sort: true}
                , {field: 'release_user_id', title: '发布者id', align: 'center', width: '12%', sort: true}
